...
function calMoreImageInfo(e, idx, that, bindName) {
  ...
  var keyW = key + '.width';
  var keyH = key + '.height';
  that.setState((_that$setState = {}, _defineProperty(_that$setState, keyW, recal.imageWidth), _defineProperty(_that$setState, keyH, recal.imageheight), _that$setState));
}
