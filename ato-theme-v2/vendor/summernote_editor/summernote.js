...
(function (factory) {
  ...
  var Style = function () {
    ...
    this.fromNode = function ($node) {
      var properties = ['font-family', 'font-size', 'text-align', 'list-style-type', 'line-height', 'letter-spacing','margin-top','margin-bottom'];
  ...
  */
  ...
  var Editor = function (context) {
     ...
     * @return {Promise}
     */
    this.insertSeamLessImage = function (src, param) {
      return async.createImage(src, param).then(function ($image) {
        beforeCommand();
        ...
        if (typeof param === 'function') {
          ...
          //$image.css('width', Math.min($editable.width(), $image.width()));
          $image.css({"width":"100%","vertical-align":"middle","margin-top":"-1px"});
        }
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      'note-link-btn disabled" disabled>' + "确定" + '</button>';
