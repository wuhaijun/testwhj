...
(function ($) {
    ...
    function sidebarPanel() {
        ...
        /* Sidebar sub-menus */
        $('.sidebar-panel nav').on('click', 'a > i', function (e) {
            ...
            $('.sidebar-panel nav li > a > i').removeClass('fa-angle-down').addClass('fa-angle-right');
            $('.sidebar-panel nav li.open > a > i').removeClass('fa-angle-right').addClass('fa-angle-down');
        ...
        /* open init active menu */
        setTimeout(function () {
            $('.sidebar-panel nav a.active').closest('li.menu-accordion').addClass('open');
        }, 500);
    }
