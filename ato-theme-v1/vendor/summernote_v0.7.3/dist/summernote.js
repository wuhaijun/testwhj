...
(function (factory) {
  ...
  var VideoDialog = function (context) {
    ...
    this.createVideoNode = function (url) {
      ...
      var $div = $('<div>').addClass('boom-video').attr('style','text-align:center;').append($video);
    ...
    //        .attr('height', '310')
    //        .attr('width', '500')
    //        .attr('src', 'http://v.qq.com/iframe/player.html?vid='+vid+'&amp;width=500&amp;height=310&amp;auto=0');
    //  } else if (mp4Match || oggMatch || webmMatch) {
    //    $video = $('<video controls>')
    //        .attr('src', url)
    //        .attr('width', '640').attr('height', '360');
